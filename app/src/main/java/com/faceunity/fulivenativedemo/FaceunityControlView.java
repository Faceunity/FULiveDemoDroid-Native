...
public class FaceunityControlView extends LinearLayout {
    ...
    public FaceunityControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEffectRecyclerAdapter.setOnItemSelectedListener(new EffectAndFilterSelectAdapter.OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(final int itemPosition) {
                if (mOnViewEventListener == null) {
                    return;
                }
                mCreateItemHandler.removeMessages(CreateItemHandler.CREATE_ITEM_WHAT);
                mCreateItemHandler.sendMessage(Message.obtain(mCreateItemHandler, CreateItemHandler.CREATE_ITEM_WHAT, itemPosition, 0));
    ...
    class CreateItemHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == CREATE_ITEM_WHAT
                    && mOnViewEventListener.onEffectItemSelected(mContext.getAssets(), EffectAndFilterSelectAdapter.EFFECT_ITEM_FILE_NAME[msg.arg1]) == 0) {
    ...
    interface OnViewEventListener {
         ...
         */
        int onEffectItemSelected(AssetManager assetManager, String effectItemName);
